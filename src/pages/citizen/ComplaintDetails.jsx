...
<div className="flex items-center justify-between border-b border-slate-200 pb-6">
  ...
  <div className="flex items-center gap-3">
    {/* Edit Button: Sirf Pending hone par dikhega */}
    {complaint?.status === "Pending" && (
      <button
        onClick={() => navigate(`/citizen/complaints/edit/${id}`)}
        className="flex items-center gap-2 px-6 py-2.5 bg-indigo-600 text-white rounded-xl text-[10px] font-black uppercase hover:bg-indigo-700 transition-all shadow-lg shadow-indigo-200"
      >
